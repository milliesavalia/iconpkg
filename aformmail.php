...
$send_to = "Icon Packaging INC<sales@iconpkg.com>";

// set $send_cc address if you need copy of mail to other addresses
// for example: $send_cc = array('rajesh_bhimani@hotmail.com', 'rajeshbhimani@hotmail.com'); 
//
$send_cc = array(); 
...
$redirect_url = 'http://www.iconpkg.com';
